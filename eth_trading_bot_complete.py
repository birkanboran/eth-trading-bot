#!/usr/bin/env python3
"""
ETH/USDT Perpetual Trading Bot - Complete Trade Signals
Swing High/Low Strategy with full trade details
5x leverage, 1% risk per trade, Bybit API, Telegram
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/home/ubuntu/bot_complete.log'),
...
class CompleteTradingBot:
    def __init__(self):
        ...
        self.timeframe = '15m'
        self.leverage = 5
        self.risk_percent = 1  # 1% risk per trade
        ...
        self.stats_file = '/home/ubuntu/bot_complete_stats.json'
        self.trades_file = '/home/ubuntu/bot_trades.json'
        self.load_stats()
        
        logger.info("Bot initialized - Complete Trading Bot (5x leverage)")
    ...
    def generate_signal(self, df: pd.DataFrame) -> Optional[Dict]:
        """Generate trading signal with complete trade details"""
        if len(df) < 10:
            return None
        ...
        all_swings = sorted([(i, 'LOW' if i in swing_lows else 'HIGH') for i in swing_lows + swing_highs])
